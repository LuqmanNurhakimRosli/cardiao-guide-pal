...
// 1. Create src/pages/patients/index.tsx
const patientsPageContent = `import { Link } from "@tanstack/react-router";
...
ensureDir('src/pages/patients');
fs.writeFileSync('src/pages/patients/index.tsx', patientsPageContent, 'utf8');
console.log('Created: src/pages/patients/index.tsx');

// 2. Update src/routes/patients.tsx
const routePatientsContent = `import { createFileRoute } from "@tanstack/react-router";
...
fs.writeFileSync('src/routes/patients.tsx', routePatientsContent, 'utf8');
console.log('Updated: src/routes/patients.tsx');
