...
// 1. Create src/pages/audit/index.tsx
const auditPageContent = `import { useState } from "react";
...
ensureDir('src/pages/audit');
fs.writeFileSync('src/pages/audit/index.tsx', auditPageContent, 'utf8');
console.log('Created: src/pages/audit/index.tsx');

// 2. Update src/routes/audit.tsx
const routeAuditContent = `import { createFileRoute } from "@tanstack/react-router";
import { z } from "zod";
...
fs.writeFileSync('src/routes/audit.tsx', routeAuditContent, 'utf8');
console.log('Updated: src/routes/audit.tsx');
