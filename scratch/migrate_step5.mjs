...
// 1. Create src/pages/timeline/index.tsx
const timelinePageContent = `import { Link } from "@tanstack/react-router";
...
ensureDir('src/pages/timeline');
fs.writeFileSync('src/pages/timeline/index.tsx', timelinePageContent, 'utf8');
console.log('Created: src/pages/timeline/index.tsx');

// 2. Update src/routes/timeline.tsx
const routeTimelineContent = `import { createFileRoute } from "@tanstack/react-router";
import { z } from "zod";
import {
  listPatients,
  getPatientWithCdss,
...
fs.writeFileSync('src/routes/timeline.tsx', routeTimelineContent, 'utf8');
console.log('Updated: src/routes/timeline.tsx');
