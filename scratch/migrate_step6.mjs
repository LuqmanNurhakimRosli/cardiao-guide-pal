...
// 1. Create src/pages/analytics/index.tsx
const analyticsPageContent = `import { useMemo, useState } from "react";
...
ensureDir('src/pages/analytics');
fs.writeFileSync('src/pages/analytics/index.tsx', analyticsPageContent, 'utf8');
console.log('Created: src/pages/analytics/index.tsx');

// 2. Update src/routes/analytics.tsx
const routeAnalyticsContent = `import { createFileRoute } from "@tanstack/react-router";
...
fs.writeFileSync('src/routes/analytics.tsx', routeAnalyticsContent, 'utf8');
console.log('Updated: src/routes/analytics.tsx');
