...
import type { Patient, CdssResult } from "@/shared/cdss/types";
import { evaluate } from "@/shared/cdss/engine";
import { runCDSS, type CdssRunResult } from "@/pages/assessment/api/cdssService";
import { cdssConfig } from "@/shared/cdss/config";
